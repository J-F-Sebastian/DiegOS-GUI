 ...
 */
static const unsigned PALETTEDIEGOS[] = {WHITE, YELLOW, ORANGE, RED, MAGENTA, PURPLE, BLUE, POWDERBLUE, GREEN, SEAGREEN, CORNSILK, FUCHSIA, LIGHTGREY, SILVER, GRAY, 0x404040, BLACK};

// Palette set for  PALETTE_WINOS2
#define C(x) PALETTEWINOS2[x]

// Bright, dark, main, dragging, disabled, active
static const unsigned framePaletteWINOS2[] = {C(15), C(0), C(7), C(9), C(8), C(10)};
// Bright, Dark, Background, text, background disabled, text disabled
static const unsigned titlebarPaletteWINOS2[] = {C(15), C(0), C(12), C(15), C(8), C(0)};
// Background, disabled, foreground
static const unsigned backgroundPaletteWINOS2[] = {C(7), C(8), C(7)};
// Background, Foreground, text, bg disabled, fg disabled, text disabled
static const unsigned progressbarPaletteWINOS2[] = {C(0), C(12), C(15), C(0), C(8), C(7)};
// Desktop background
static const unsigned desktopPaletteWINOS2[] = {C(10)};
// Bright, Dark, main, selected, disabled, pressed
static const unsigned buttonPaletteWINOS2[] = {C(15), C(0), C(7), C(9), C(0), C(11)};
// Bright, Dark, main, pressed, released, dragging, disabled
static const unsigned winiconPaletteWINOS2[] = {C(15), C(0), C(7), C(9), C(0), C(9), C(0)};
// Bright, Dark, Foreground, Background, disabled
static const unsigned scrollbarPaletteWINOS2[] = {C(15), C(0), C(3), C(7), C(0)};

// Palette set for  PALETTE_DEBUG

// Bright, dark, main, dragging, disabled, active
static const unsigned framePaletteDBG[] = {RED, GREEN, BLUE, YELLOW, DARKGREEN, WHITE};
// Bright, Dark, Background, text, background disabled, text disabled
static const unsigned titlebarPaletteDBG[] = {RED, GREEN, YELLOW, WHITE, BLACK, DARKGREY};
// Background, disabled, foreground
static const unsigned backgroundPaletteDBG[] = {AQUA, BLUE, YELLOW};
// Background, Foreground, text, bg disabled, fg disabled, text disabled
static const unsigned progressbarPaletteDBG[] = {BLACK, BLUE, WHITE, BLACK, DARKGREY, DARKGREEN};
// Desktop background
static const unsigned desktopPaletteDBG[] = {BLACK};
// Bright, Dark, main, selected, disabled, pressed
static const unsigned buttonPaletteDBG[] = {WHITE, BLACK, SILVER, RED, BLACK, YELLOW};
// Bright, Dark, main, pressed, released, dragging, disabled
static const unsigned winiconPaletteDBG[] = {WHITE, BLACK, SILVER, RED, BLACK, MAGENTA, DARKGREY};
// Bright, Dark, Foreground, Background, disabled
static const unsigned scrollbarPaletteDBG[] = {WHITE, BLACK, SILVER, RED, BLACK};
...
// Bright, dark, main, dragging, disabled, active
static const unsigned framePaletteMAC[] = {C(12), C(14), C(13), C(9), C(14), C(8)};
// Bright, Dark, Background, text, background disabled, text disabled
static const unsigned titlebarPaletteMAC[] = {C(12), C(14), C(0), C(15), C(13), C(15)};
// Background, disabled, foreground
static const unsigned backgroundPaletteMAC[] = {C(12), C(13), C(0)};
// Background, Foreground, text, bg disabled, fg disabled, text disabled
static const unsigned progressbarPaletteMAC[] = {C(12), C(14), C(0), C(15), C(14), C(13)};
// Desktop background
static const unsigned desktopPaletteMAC[] = {C(12)};
// Bright, Dark, main, selected, disabled, pressed
static const unsigned buttonPaletteMAC[] = {C(0), C(15), C(12), C(3), C(15), C(1)};
// Bright, Dark, main, pressed, released, dragging, disabled
static const unsigned winiconPaletteMAC[] = {C(0), C(15), C(12), C(3), C(15), C(9), C(14)};
// Bright, Dark, Foreground, Background, disabled
static const unsigned scrollbarPaletteMAC[] = {C(12), C(14), C(13), C(15), C(14)};
...
// Bright, dark, main, dragging, disabled, active
static const unsigned framePaletteRISCOS[] = {C(4), C(7), C(1), C(9), C(6), C(4)};
// Bright, Dark, Background, text, background disabled, text disabled
static const unsigned titlebarPaletteRISCOS[] = {C(4), C(7), C(12), C(7), C(5), C(7)};
// Background, disabled, foreground
static const unsigned backgroundPaletteRISCOS[] = {C(2), C(12), C(6)};
// Background, Foreground, text, bg disabled, fg disabled, text disabled
static const unsigned progressbarPaletteRISCOS[] = {C(5), C(10), C(0), C(7), C(6), C(2)};
// Desktop background
static const unsigned desktopPaletteRISCOS[] = {C(3)};
// Bright, Dark, main, selected, disabled, pressed
static const unsigned buttonPaletteRISCOS[] = {C(4), C(7), C(1), C(7), C(6), C(14)};
// Bright, Dark, main, pressed, released, dragging, disabled
static const unsigned winiconPaletteRISCOS[] = {C(12), C(6), C(12), C(7), C(15), C(9), C(6)};
// Bright, Dark, Foreground, Background, disabled
static const unsigned scrollbarPaletteRISCOS[] = {C(4), C(7), C(1), C(5), C(6)};
...
// Bright, dark, main, dragging, disabled, active
static const unsigned framePaletteDIEGOS[] = {C(12), C(14), C(13), C(9), C(15), C(0)};
// Bright, Dark, Background, text, background disabled, text disabled
static const unsigned titlebarPaletteDIEGOS[] = {C(12), C(14), C(13), C(1), C(15), C(14)};
// Background, disabled, Foreground
static const unsigned backgroundPaletteDIEGOS[] = {C(10), C(14), C(7)};
// Background, Foreground, text, bg disabled, fg disabled, text disabled
static const unsigned progressbarPaletteDIEGOS[] = {C(14), C(9), C(0), C(7), C(6), C(2)};
// Desktop background
static const unsigned desktopPaletteDIEGOS[] = {C(2)};
// Bright, Dark, main, selected, disabled, pressed
static const unsigned buttonPaletteDIEGOS[] = {C(12), C(14), C(13), C(9), C(14), C(8)};
// Bright, Dark, main, pressed, released, dragging, disabled
static const unsigned winiconPaletteDIEGOS[] = {C(12), C(14), C(13), C(3), C(15), C(9), C(15)};
// Bright, Dark, Foreground, Background, disabled
